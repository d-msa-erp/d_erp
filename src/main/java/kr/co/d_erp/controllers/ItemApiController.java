...
public class ItemApiController {
	...
	public ResponseEntity<String> createItem(@RequestBody Item item) {
		try {
			...
			return new ResponseEntity<>("품목 등록 중 서버 오류가 발생했습니다.", HttpStatus.INTERNAL_SERVER_ERROR); // 500 Internal
																										// Server Error
		}
	}
	...
	// 품목 리스트 출력 메소드
	@GetMapping
	public ResponseEntity<List<Item>> getAllItems(@RequestParam(value = "page", defaultValue = "1") int page,
	...
	public ResponseEntity<Item> updateItem(@PathVariable("item_IDX") int item_IDX, @RequestBody Item updatedItem) {
